    ...
    >
      ...
      <div className="mt-10 divide-y divide-border/60 rounded-2xl border border-border/80 bg-card/60 backdrop-blur-md overflow-hidden shadow-sm">
        {faqs.map((faq, index) => (
          ...
          >
            <summary className="flex cursor-pointer items-center justify-between gap-4 list-none text-left font-sans text-lg sm:text-xl font-medium text-foreground outline-none">
