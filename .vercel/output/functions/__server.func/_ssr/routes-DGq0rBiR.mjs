...
import { a as sideProjects$1, i as navLinks, n as Route$10, o as skills$1, r as businesses$1, s as cn } from "./router-D8ljk-hX.mjs";
import { a as CardFooter, c as Input, i as CardDescription, l as Label, n as Card, o as CardHeader, r as CardContent, s as CardTitle, t as Button } from "./card-D0ZT42Q2.mjs";
import { a as TabsTrigger, i as TabsList, n as Tabs, o as Textarea, r as TabsContent, t as Badge } from "./badge-BYC_VidZ.mjs";
import { t as Root } from "../_libs/radix-ui__react-separator.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DGq0rBiR.js
...
function SidePreview({ title }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "relative flex h-28 items-end overflow-hidden rounded-xl bg-secondary p-4 outline outline-1 -outline-offset-1 outline-white/10",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[linear-gradient(160deg,transparent,rgba(255,255,255,0.03))]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "relative font-serif text-xl text-foreground/80",
			children: title
		})]
	});
}
...
function ResumeModal({ trigger, open, onOpenChange, email, pdfUrl = "/resume.pdf", summary, education, skillsList }) {
	const handlePrint = () => {
		window.print();
	};
		...
		children: [
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					className: `p-5 transition-all duration-300 ${item.color} ${item.highlight ? "border-sage/30 bg-gradient-to-b from-card to-sage/5" : ""}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
								...
								children: "Building Trelio. Open for high-impact software engineering roles."
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								href: "#top",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
								...
								" Nagulagam Chanakya. All rights reserved."
							] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Designed & Engineered with care · Trelio SaaS" })]
						})
					]
				})
			})
